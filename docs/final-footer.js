  ...
  const setupHeaderControls = () => {
    ...
    if (!document.querySelector('#vei-header-controls-styles')) {
      ...
      style.textContent = `
        ...
        .nav-download.vei-download-toggle:hover{color:#ff8069!important;transform:none!important}.vei-download-chevron{display:inline-flex!important;align-items:center!important;justify-content:center!important;width:16px!important;height:16px!important;margin-left:6px!important;transform-origin:center;transition:transform .18s ease}.vei-download-chevron svg{display:block;width:16px;height:16px;fill:none;stroke:currentColor;stroke-width:1.8;stroke-linecap:round;stroke-linejoin:round}.vei-download-wrap.is-open .vei-download-chevron{transform:rotate(180deg)}
