        ...
        <div class="payment-stage-window"><div class="payment-stage-track" id="paymentStageTrack">
          <div class="payment-stage">
            ...
            <div class="payment-method-list">
              <button class="payment-method-option" id="sbpPaymentsOption" type="button"><span class="payment-method-icon"><img src="assets/payments/sbp.png" alt="СБП"></span><span class="payment-method-copy"><strong>СБП</strong><small>Оплата через Систему быстрых платежей</small></span><span class="payment-method-arrow">›</span></button>
